...
/**
 * REST controller for managing {@link com.mdweb.evisa.domain.Person}.
 */
@RestController
@RequestMapping("/api")
public class PersonResource {
    ...
    public ResponseEntity<PersonDTO> updatePerson(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, personDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<PersonDTO> partialUpdatePerson(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, personDTO.getId())
        );
    }
